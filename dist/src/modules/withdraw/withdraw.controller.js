...
let WithdrawController = class WithdrawController {
    ...
    async withdraw(dto) {
        return this.withdrawService.withdraw(dto);
    }
    async getHistory(userId) {
        return this.withdrawService.getWithdrawHistory(userId);
    }
};
...
], WithdrawController.prototype, "withdraw", null);
__decorate([
...
exports.WithdrawController = WithdrawController = __decorate([
    (0, common_1.Controller)('api/withdraw'),
